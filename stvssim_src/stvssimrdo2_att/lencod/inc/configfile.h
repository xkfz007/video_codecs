...
Mapping Map[] = {
    ...
    {"InfoFile",                 &configinput.InfoFile,                     1,   0.0,                       0,  0.0,              0.0              },
    {"AvgFile",                  &configinput.AvgFile,                      1,   0.0,                       0,  0.0,              0.0              },
    {"MbRDdataFile",             &configinput.MbRDdataFile,                 1,   0.0,                       0,  0.0,              0.0              },
    {"LambdaFunc",               &configinput.lambda_func,                  0,   1.0,                       1,  0.0,              3.0              },
