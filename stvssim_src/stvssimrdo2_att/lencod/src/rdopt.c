...
#if _RDO_STVSSIM2_
  getDistortion = distortionstVSSIM2;
#elif _RDO_STVSSIM_
  getDistortion = distortionstVSSIM;
#elif _RDO_SSIM3D_
  getDistortion = distortionSSIM3D;
#elif _RDO_SSIM_
  getDistortion = distortionSSIM;
#else
                                  ...
                                  int c_nzCbCr[3])
{
...
#if _RDO_STVSSIM2_
 {
  ...
  compute_stVSSIM2(pCurImg,enc_picture->imgY,pic_opix_y,pic_pix_y,pic_pix_x,pic_pix_x,
	  4,4,4,img->number+1,0,&ssimValue,&ssim3dValue,&stvssimValue);
  distortion+=1.0f-stvssimValue;
  }
#elif _RDO_STVSSIM_
  {
  float ssimValue,ssim3dValue,stvssimValue;
  compute_stVSSIM(pCurImg,enc_picture->imgY,pic_opix_y,pic_pix_y,pic_pix_x,pic_pix_x,
	  4,4,4,img->number+1,0,&ssimValue,&ssim3dValue,&stvssimValue);
  distortion+=1.0f-stvssimValue;
  }
#elif _RDO_SSIM3D_
  distortion+=1.0f-compute_SSIM3D(pCurImg,enc_picture->imgY,pic_opix_y,pic_pix_y,pic_pix_x,pic_pix_x,4,4,4,img->number+1,0);

#elif _RDO_SSIM_
  distortion+=1.0f-compute_SSIM(pCurImg,enc_picture->imgY,pic_opix_y,pic_pix_y,pic_pix_x,pic_pix_x,4,4,4,0);
#else
                             ...
                             )     
{
  ...
  {    
#if _RDO_STVSSIM2_
	  {
		  float ssimValue,stvssimValue,ssim3dValue;
		  compute_stVSSIM2(pCurImg,enc_picture->imgY,img->opix_y+pay,img->pix_y+pay,img->opix_x+pax,img->pix_x+pax,
			  8,8,8,img->number+1,0,&ssimValue,&ssim3dValue,&stvssimValue);
		  distortion+=1.0f-stvssimValue;
	  ...
	  {
	  float ssimValue,stvssimValue,ssim3dValue;
	  compute_stVSSIM(pCurImg,enc_picture->imgY,img->opix_y+pay,img->pix_y+pay,img->opix_x+pax,img->pix_x+pax,
		  8,8,8,img->number+1,0,&ssimValue,&ssim3dValue,&stvssimValue);
	  distortion+=1.0f-stvssimValue;

	  }
#elif _RDO_SSIM3D_
  distortion+=1.0f-compute_SSIM3D(pCurImg,enc_picture->imgY,img->opix_y+pay,img->pix_y+pay,img->opix_x+pax,img->pix_x+pax,8,8,8,img->number+1,0);

#elif _RDO_SSIM_
  distortion+=1.0f-compute_SSIM(pCurImg,enc_picture->imgY,img->opix_y+pay,img->pix_y+pay,img->opix_x+pax,img->pix_x+pax,8,8,8,0);
#else
